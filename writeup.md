...
* training set accuracy 1st run: 99.7 % second run: 99.4 %
* validation set accuracy 1st run: 94.6 % second second: 94.3 %
* test set accuracy 1st run: 90.2 %, second run: 89.0 %
...
The model was able to detect 5 out of 5 traffic sign correct. Although the yield sign has a low contrast, the classifier is able to detect it right.
...
With the Yield sign the classifier is most certain. The factor of the second classification is 3.66.
